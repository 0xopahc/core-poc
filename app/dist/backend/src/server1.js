...
const app = express();
const indexPath = '/home/andowens/core-poc/app/backend/src/public/index.html';
...
app.get('/about', (req, res) => {
    try {
        ...
        const ip = req.headers['x-forwarded-for']?.toString().split(',')[0].trim() || // use if behind a proxy
